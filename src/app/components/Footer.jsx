        ...
        <>
           ...
           Task Frontend
                    ...
                    <p className="text-sm mt-8 text-gray-200">
                       Kumar Shaikat Bala Full Stack Developer Have Experties on Php Laravel , React Next js ,Vue Nuxt ,Node js Express ,Python Django
                        <br/>
                        kumarshaikatbala@gmail.com
                        <br/>
                        01617777010
                        <br/>
                        01978777010
